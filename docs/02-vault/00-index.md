...
* 📄 [`source-priority.md`](https://github.com/thgnud1022/group-01-project/blob/main/docs/02-vault/source-priority.md) - Quy tắc phân xử mâu thuẫn nguồn (6 cấp độ).
* 📄 [`company-policies.md`](https://github.com/thgnud1022/group-01-project/blob/main/docs/02-vault/company-policies.md) - Quy chế thu mua và hạn mức phê duyệt nội bộ.
